        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                disabled={!formData.merk || models.length === 0}
                onChange={handleChange}
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 text-black bg-white disabled:bg-gray-100 disabled:text-gray-400"
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              required
              placeholder="Jelaskan kondisi mobil..."
              onChange={handleChange}
              className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 text-black"
            />
          </div>
